...
if selected == "About Project":
    st.markdown("# :black[Singapore Resale Flat Prices Prediction]")
...
if selected == "Predictions":
    st.markdown("# :black[Predicting Results based on Trained Models]")
    st.markdown("### :orange[Predicting Resale Price (Regression Task) (Accuracy: 88%)]")
    ...
    try:
        with st.form("form1"):
            ...
            if submit_button is not None:
                ...
                st.write('## :red[Predicted resale price:] ', np.exp(new_pred))
